...
<body>
<form class="w3-container w3-card-4" action="calenderchangereg.me" method="post" name="sf">
	...
	<input type="hidden" name="no" value="${cal.no}">
	<input type="hidden" name="kindno" value="${cal.kindno}">
	...
	<p>
		...
		<input class="w3-input w3-border w3-light-gray" name="subject" type="text" value="${cal.subject }">
	</p>
	<p>
		<label class="w3-text-dark-grey"><b>내용</b></label> 
		<textarea class="w3-input w3-border w3-light-gray" rows="20" cols="30" name="content">${cal.content }</textarea>
	</p>
