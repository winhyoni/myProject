...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  <a href="${path }/model2/main.me?year=${year }&month=${month}" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>효니</a><!-- 로고 -->
  <a href="${path }/model2/logout.me?year=${year }&month=${month}" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="login"><i class="fa fa-sign-out">&nbsp;로그아웃</i></a>
  <a href="${path }/model2/member/empinfo.jsp?year=${year }&month=${month}" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="Account Settings"><i class="fa fa-user">&nbsp;개인정보</i></a>
 </div>
</div>
    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <p class="w3-center"><img src="${path }/model2/member/img/${data.picture }" class="w3-circle" style="width:100px; higth:140px;" alt="사진없음"></p>
         <hr>
        ...
        <div class="w3-white">
         <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>로그인</button>
          <div id="Demo1" class="w3-hide w3-container">
            ...
            <a href="${path }/model2/logout.me?year=${year }&month=${month}"> ● 로그아웃</a>
          </div>
