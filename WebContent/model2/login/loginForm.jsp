...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  <a href="loginForm.me?year=${year }&month=${month}" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>효니</a><!-- 로고 -->
  <a href="loginForm.me?year=${year }&month=${month}" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="login"><i class="fa fa-sign-in">&nbsp;로그인</i></a>
        ...
        <div class="w3-white">
         <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>로그인</button>
          <div id="Demo1" class="w3-hide w3-container">
          	<a href="loginForm.me?year=${year }&month=${month}"> ● 로그인</a><br>
         ...
         <button onclick="myFunction('Demo3')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>주소록</button>
          <div id="Demo3" class="w3-hide w3-container">
            ...
            <a href="javascript:logincheck()"> ● 팀 직원 주소</a><br>
          </div>
         <button onclick="myFunction('Demo5')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-circle-o-notch fa-fw w3-margin-right"></i>자료실</button>
          <div id="Demo5" class="w3-hide w3-container">
            <a href="javascript:logincheck()"> ● 서류 양식 및 프로그램</a><br>
          </div>
