...
<div class="w3-card-4">
						...
						<form  class="w3-container"  action="ini.me" method="post">
							...
							<p>
								<label class="w3-text-dark-grey"><b>주민번호 뒷 7자리</b></label> <input
									class="w3-input w3-border w3-sand" name="jumin" type="password">
							</p>
							<p>
